			...
			if (e.getSource().equals(aendernButton) && !isBeingChanged) {
				...
				try {
					...
					if (operator.equals("+") || operator.equals("-")) {
						...
						throw new NumberFormatException("Kein gÃ¼ltiger Operator! Nur + und - sind erlaubt!");
					}
					try {
						...
						try {
							...
							JOptionPane.showMessageDialog(ArtikelVerwaltungsfenster.this, "Keine gueltige PackungsgrÃ¶ÃŸe");
						}
					} catch (NumberFormatException e1) {
	...
	class ArtikelInWarenkorbListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				JOptionPane.showMessageDialog(ArtikelVerwaltungsfenster.this, "Kein Artikel ausgewÃ¤hlt");
