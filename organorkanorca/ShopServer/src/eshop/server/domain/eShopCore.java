...
public class eShopCore extends UnicastRemoteObject implements ShopRemote {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see domain.ShopRemote#artikelInWarenkorbAendern(data_objects.Artikel, int,
	 * data_objects.Person)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see domain.ShopRemote#artikelInWarenkorbLegen(int, int, data_objects.Person)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see domain.ShopRemote#artikelSuchen(java.lang.String, data_objects.Person)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see domain.ShopRemote#erhoeheArtikelBestand(int, int, data_objects.Person)
	 */
	@Override
	...
	@Override
	public Artikel artikelAendern(int artikelnummer, Person p, String bezeichnung, int bestand, String operator, double preis,
